...
func (c *Clients) ListContainerInstances(cluster *string) ([]types.ContainerInstance, error) {
	batchSize := 100
	...
	listOutput, err := c.ECS().ListContainerInstances(context.Background(), params)
	if err != nil {
